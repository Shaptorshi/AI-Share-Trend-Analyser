...
export async function POST(req: NextRequest) {
    ...
    for (const horizon of ['7d', '14d', '1m', '3m'] as const) {
        const horizonMap = {
            ...
            '1m': { price: p.predicted_price_7d, low: p.range_low_7d * 0.93, high: p.range_high_7d * 1.1 },
            '3m': { price: p.predicted_price_7d, low: p.range_low_7d * 0.85, high: p.range_high_7d * 1.25 },
        }
